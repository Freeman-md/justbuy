...
$classes = ($active ?? false)
            ? 'block pl-3 pr-4 py-2 border-l-4 border-secondary text-base font-medium text-gray-800 bg-gray-50 focus:outline-none focus:text-black focus:bg-gray-100 focus:border-secondary transition'
